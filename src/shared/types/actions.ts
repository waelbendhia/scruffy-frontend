...
export interface IAction<T, P> { type: T; payload: P; }
export interface IActionNoPayload<T> { type: T; }
export interface IActionFailable<T, P> { type: T; payload: IResult<P>; }
...
export const actionCreator = <A extends IAction<{}, {}>>(type: ActionType<A>) =>
...
export const failableActionCreator =
...
type ActionCaseOf<A extends IActionNoPayload<string>, S> = {
    [key in ActionType<A>]: (a: A extends IActionFailable<key, unknown>
        ? A
